...
def main():
    ...
    env.add_jars('file:///Users/airscholar/PycharmProjects/FlinkAlgorithmicTrading/libs/flink-sql-connector-kafka-3.1.0-1.18.jar')

    kafka_consumer_properties = {
        'bootstrap.servers': 'localhost:9092,localhost:9093',
        'group.id': 'news_trading_consumer_group5',
